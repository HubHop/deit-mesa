...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='deit_ms_tiny_patch16_224', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/datasets/cifar100', type=str,
                        help='dataset path')
...
def main(args):
    ...
    inputs = torch.rand(64, 3, 224, 224).cuda()

    mem_log = []
    try:
        mem_log.extend(log_mem(model, inputs, exp='baseline'))
    except Exception as e:
        print(f'log_mem failed because of {e}')
    import json
    with open('base_mem_info.json', 'w+') as f:
